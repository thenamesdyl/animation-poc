...
class ModelEditorLasso {
     ...
     */
    constructor(camera, domElement, mesh) {
        this.camera = camera;
    ...
    _onMouseDown(event) {
        ...
        this._lassoPoints = [];
        this.selectedVertices.clear(); // Clear previous selection
    ...
    _onMouseUp(event) {
        ...
        // You might want to trigger an event or callback here with the selected vertices
    }
